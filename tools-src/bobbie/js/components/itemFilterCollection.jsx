...
var RemoveBtn = React.createClass({
    ...
    _onClick: function (e) {
        ...
        appActions.removeItemFilter(this.props.index);
    }
});

var ItemFilterCollection = React.createClass({

    render: function () {
        var numItems = this.props.collection.length;
        var rows = this.props.collection.reduce(function (rows, item, index) {
            rows.push(
                <ItemFilter index={index} values={item}/>
            );
...
module.exports = ItemFilterCollection;
