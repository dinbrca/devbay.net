...
var CategoryId = require('./categoryId.jsx');
...
var RemoveBtn = React.createClass({
    ...
    _onClick: function (e) {
        ...
        appActions.removeCategoryId(this.props.index);
    }
});

var CategoryIdCollection = React.createClass({
    ...
    render: function () {
        ...
        var rows = this.props.collection.reduce(function (rows, item, index) {
            ...
            } else if (index < numItems - 1 || numItems === 3) {
                rows.push(
                    <div className='row'>
                        <div className='small-6 large-6 columns'>
                            <CategoryId
...
module.exports = CategoryIdCollection;
